  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="{{route('users.index')}}"><i class="fa fa-link"></i> <span>Manage Users</span></a></li>
        <li><a href="{{route('companies.index')}}"><i class="fa fa-link"></i> <span>Manage Company</span></a></li> 
        <li><a href="{{route('onchange.index')}}"><i class="fa fa-link"></i> <span>Address</span></a></li> 

        {{--<li class="treeview">
          <a href="#"><i class="fa fa-money"></i> <span>Income</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
          {{--<ul class="treeview-menu">
            <li><a href="#">Innvoice</a></li>
       ...
       {{--   <ul class="treeview-menu">
            ...
            <li><a href="#">Curriences</a></li>
            <li><a href="#">Tax Rates</a></li>
            <li><a href="#">Offline Payments</a></li>
            <li><a href="#">Paypal Standard</a></li>
          </ul>--}}
        </li>
        <ul>
        {{--<li class="treeview">
          <a href="#"><i class="fa fa-user"></i> <span>Banking</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
